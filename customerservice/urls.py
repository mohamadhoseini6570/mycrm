...
urlpatterns = [
    ...
    path('cloud/<int:pk>/delete', views.CloudDelete.as_view(),
        name='cloud-delete'),
    # path('customers/search/', views.CustomerSearchList.as_view(),
    #   name='customers-search'),
    path('customers/search/', views.CustomerSearch,
        name='customers-search'),
    path('customers/searchp/', views.CustomerSearchP,
        name='customers-searchp'),
    path('customers/newsearch/', views.NewCustomerSearch,
        name='new-customers-search'),
    path('customer/<int:pk>/services', views.CustomerListServices,
