...
urlpatterns = [
    ...
    path('cloud/<int:pk>/update', views.CloudUpdate.as_view(), name='cloud-update'),
    ...
    path('cloud/<int:pk>/delete', views.CloudDelete.as_view(), name='cloud-delete'),
    ...
    path('customer/<int:pk>/services', views.CustomerListServices, name='customer-services'),
